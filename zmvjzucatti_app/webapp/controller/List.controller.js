sap.ui.define([
    ...
    return BaseController.extend("moovi.zmvjzucattiapp.controller.List", {
        ...
        onOpenViewSettings: function (oEvent) {
            ...
            if (!this.byId("viewSettingsDialog")) {
                Fragment.load({
                    ...
                    name: "moovi.zmvjzucattiapp.view.ViewSettingsDialog",
                    controller: this
        ...
        onBtnCreatePress: function (oEvent) {
            ...
            if (!this.oDialogEditCompany) {
                ...
                this.oDialogEditCompany = Fragment.load({
                    id: this.getView().getId(),
                    name: "moovi.zmvjzucattiapp.view.EditCompanyDialog",
                    controller: this
                }).then(function (oDialog) {
                    // connect dialog to the root view of this component (models, lifecycle)
                    this.getView().addDependent(oDialog);
