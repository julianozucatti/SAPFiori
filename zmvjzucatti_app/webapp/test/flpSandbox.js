		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#moovizmvjzucattiapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"moovizmvjzucattiapp-display": {
								"semanticObject": "moovizmvjzucattiapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=moovi.zmvjzucattiapp",
									"url": sap.ui.require.toUrl("moovi/zmvjzucattiapp")
								}
							}
						}
					}
